                                            ...
                                            <div className='flex-1'>
                                                ...
                                                <div className='flex items-center justify-between'>
                                                    <h3 className='font-semibold text-zinc-900'>
                                                        {b.driver.name.toUpperCase()! || "Driver Name"}</h3>
                                        ...
                                        <div className='flex items-center justify-between px-4 py-3 border-t border-zinc-200'>
                                            ...
                                            {(b.bookingStatus == 'completed'|| b.bookingStatus == 'started'||
                                                ...
                                                <button
                                                    ...
                                                    className='flex items-center gap-1 text-sm font-medium text-blue-500 hover:text-blue-700 bg-blue-50 hover:bg-blue-200
