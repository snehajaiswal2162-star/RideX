...
const KPI_CONFIG : Record<string, {
  ...
  totalPartners: {
    ...
    cardHover: "hover:shadow-purple-400/70"
  },
  approved: {
    iconBg: "bg-blue-50",
    iconColor: "text-blue-800",
    cardHover: "hover:shadow-blue-200/70"
  },
  pending: {
    iconBg: "bg-amber-50",
    iconColor: "text-amber-800",
    cardHover: "hover:shadow-amber-200/70"
  },
  rejected: {
    iconBg: "bg-red-50",
    iconColor: "text-red-800",
    cardHover: "hover:shadow-red-200/70"
  },

}

const Kpi = ({label, value, icon, variant}: any) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0  opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-2xl ${cfg.iconBg}`} style={{ zIndex:0}}/>
...
{icon}
          ...
          <p className='uppercase text-xs font-semibold tracking-widest text-gray-400 mb-1'>{label}</p>
          <motion.div
